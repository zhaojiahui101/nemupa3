...
make_group(group5,
	...
	jmp_rm_v/*jmp_rm_l*/, inv, push_rm_v, inv)
...
/* 0x20 */	and_r2rm_b, and_r2rm_v, and_rm2r_b, inv,
...
/* 0xe8 */	call_si,jmp_i_v /*jmp_si_l*/, jmp_inter_v, jmp_i_b/*jmp_si_b*/,
